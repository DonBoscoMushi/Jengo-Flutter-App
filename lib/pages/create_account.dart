        ...
        if (!hasInternet!) {
          ...
          await RemoteConfigService().getCredentials().then((List<String> credentials) {
            if (credentials.isNotEmpty) {
              AuthService().customAuthenticationViaJWT(credentials[0], credentials[1]).then((JwtStatus? status) async {
                if (status == null || status.isSuccessfull == false) {
                  ...
                  await AuthService()
                    ...
                    if (authStatus == null ||
                        authStatus.isSuccessfull == false) {
                      _btnController.reset();
                      ...
                      await ub
                          .guestUserSignout()
                          .then(
                              (value) => ub.saveUserData(authStatus.userModel!))
