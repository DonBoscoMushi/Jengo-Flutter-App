...
/// if your website URL does not contain path then leave WORDPRESS_URL_PATH empty.
 ...
 String WORDPRESS_URL_DOMAIN = "https://jengo.co.tz";
 String WORDPRESS_URL_PATH = "";


String APP_TERMS_URL = "https://jengo.co.tz/terms-conditions";
String APP_PRIVACY_URL = "https://jengo.co.tz/privacy-policy";
String APP_TERMS_OF_USE_URL = "https://jengo.co.tz/terms-of-use";
String WORDPRESS_URL_GDPR_AGREEMENT = "https://jengo.co.t/terms";

/// Your Company Related
String COMPANY_URL = "https://jengo.co.tz/about";
...
const String APPLE_SIGN_ON_CLIENT_ID = "com.jengo.app.signin";
...
const String COMPANY_NAME = "Jengo Real Estate.";
...
const String APP_BASE_URL = 'jengo.co.tz';
...
const String DEMO_URL = 'https://jengo.co.tz/';
...
const String PROPERTY_MEDIA_EXAMPLE_URL = 'https://www.youtube.com/';
